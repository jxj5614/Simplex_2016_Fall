...
class Application
{
	...
	float radians = 2 * PI; //Radians in a circle is always 2 PI
	float lerpVal = 0.0f; //bound between 0 and 1
	std::vector<std::vector<vector3>> orbitStops; //vector of stop lists for every orbit
	std::vector<int> currentOrbitStop; //orbits current stopo
